    ...
    return (
        ...
        <div className="container">
            <div className="bg-white">
                <p className="text-xl font-semibold p-2 lg:ml-4 sm:text-center lg:text-justify">Productos Relacionados</p>
            </div>
            <Swiper
...
export default SliderProdRelacionado;